  ...
  return (
    <>
      <header className="space-y-1">
        ...
        <h1 className="text-2xl font-bold text-orange-900">Head of Department</h1>
        <p className="text-sm text-gray-600">
          Manage your account details, theme preferences, and credentials here.
        </p>
      </header>
      ...
      <section className="bg-white rounded-2xl border border-orange-200 shadow-sm p-6 space-y-4 max-w-2xl">
        ...
        <div className="flex items-center gap-4">
          <div className="w-20 h-20 rounded-full border-4 border-orange-200 overflow-hidden bg-orange-50 flex items-center justify-center">
            {user.imageUrl ? (
              <img src={user.imageUrl} alt={user.fullName || user.username || 'HOD'} className="w-full h-full object-cover" />
            ) : (
