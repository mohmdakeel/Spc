...
const PREFS_KEY = 'transport-settings';
const THEME_KEY = 'transport-workspace-theme';
  ...
  return (
    <div className="space-y-4">
      <header>
        ...
        <h1 className="text-2xl font-bold text-orange-900">Transport Settings</h1>
        <p className="text-sm text-gray-600">
          Control notification channels and appearance for the transport workspace.
        </p>
      </header>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <section className="bg-white rounded-2xl border border-orange-200 shadow-sm p-6 space-y-4">
          ...
          <div className="space-y-4 text-sm text-gray-700">
            <ToggleRow
              title="Email updates"
              description="Get a summary when a request or vehicle status changes."
              checked={prefs.notifyEmail}
              onChange={() => toggle('notifyEmail')}
            />
            <ToggleRow
              title="SMS alerts"
              description="Urgent reminders for dispatches and pickups within 12 hours."
        ...
        <section className="bg-white rounded-2xl border border-orange-200 shadow-sm p-6 space-y-4">
          ...
          <p className="text-sm text-gray-600">Switch between light and dark modes for the transport workspace.</p>
