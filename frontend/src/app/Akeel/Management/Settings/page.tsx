...
const PREFS_KEY = 'management-settings';
  ...
  return (
    <div className="space-y-4">
      <header>
        ...
        <h1 className="text-2xl font-bold text-orange-900">Management Settings</h1>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <section className="bg-white rounded-2xl border border-orange-200 shadow-sm p-6 space-y-4">
          ...
          <div className="space-y-4 text-sm text-gray-700">
            <ToggleRow
              title="Email updates"
              description="Get a summary when requests move to the next stage."
              checked={prefs.notifyEmail}
              onChange={() => toggle('notifyEmail')}
            />
            <ToggleRow
              title="SMS alerts"
              description="Urgent reminders for time-sensitive approvals."
