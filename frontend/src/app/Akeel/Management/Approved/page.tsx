...
/* ---------- tiny helpers (match other pages) ---------- */
const chip = (s: string) => (
  <span className="inline-block text-[8px] px-1 py-[1px] rounded bg-green-100 text-green-800 leading-none">
    {s}
  </span>
);
...
/** Remove embedded "Travelling Officer: ..." from description when printing/details */
...
<html>
<head>
<meta charset="utf-8"/><title>Approved Requests — Print</title>
...
<div class="grid">
  ...
  <div><div class="block">Status</div>APPROVED</div>
    ...
    <div className="flex min-h-screen bg-orange-50">
      ...
      <main className="p-2 md:p-3 flex-1">
        <div className="flex items-center justify-between mb-2">
          <h1 className="text-[12px] font-semibold text-orange-900">Approved Requests</h1>
          <div className="flex items-center gap-2">
            <SearchBar value={q} onChange={setQ} placeholder="Search code, applicant, dept, route…" className="h-7 text-[11px]" />
            <button
              type="button"
              onClick={printPage}
                ...
                filtered.map((r: any) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Status */}
                      <Td className="px-1.5 py-1 text-center">{chip('APPROVED')}</Td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <section className="md:col-span-2 border border-orange-100 rounded-lg p-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <div><div className="text-gray-600">Travelling with Officer</div>{extractOfficer(request as any).withOfficer ? 'Yes' : 'No'}</div>
                  <div><div className="text-gray-600">Officer Name</div>{extractOfficer(request as any).name || '—'}</div>
                  <div><div className="text-gray-600">Officer Employee ID</div>{extractOfficer(request as any).id || '—'}</div>
                  <div><div className="text-gray-600">Officer Phone</div>{extractOfficer(request as any).phone || '—'}</div>
                </div>
              </div>
            </section>
