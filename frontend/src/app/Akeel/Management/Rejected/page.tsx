...
/** Remove embedded "Travelling Officer: ..." from description (for print/details) */
...
<html>
<head>
<meta charset="utf-8"/><title>Rejected Requests — Print</title>
    ...
    <div className="flex min-h-screen bg-orange-50">
      ...
      <main className="p-2 md:p-3 flex-1">
        <div className="flex items-center justify-between mb-2">
          <h1 className="text-[12px] font-semibold text-orange-900">Rejected Requests</h1>
